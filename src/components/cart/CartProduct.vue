      ...
      <div class="row">
        ...
        <div class="col-8">
            ...
            <div class="d-flex">
                ...
                <p>shipping to <span class="fw-semibold">Madangan Kelod, Petak, Gianyar, Bali, Indonesia</span></p>
            </div>
            ...
            <div v-else class="empty-cart text-center my-5">
                <i class="fa-solid fa-cart-shopping mb-3" style="font-size: 100px; color: darkgreen;"></i>
