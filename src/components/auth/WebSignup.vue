<template>
        ...
        <form class="px-4 py-3 form-loginsignup border" @submit.prevent="register">
          ...
          <div class="form-check mb-3">
            ...
            <label class="form-check-label" for="termsCheckbox">
              By clicking sign up, I agree to the <a href="#" class="text-green">Terms & Conditions</a> and confirm that I have read the <a href="#" class="text-green">Privacy policy</a>.
            </label>
          </div>
  ...
  <div v-if="showSuccessModal" class="custom-modal-overlay">
    <div class="custom-modal border">
      <i class="fa-solid fa-paper-plane my-5 text-green icon-large"></i>
