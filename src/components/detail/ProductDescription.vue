        ...
        <div class="col-4">
          <div class="card">
            ...
            <div class="card-footer">
              <a href="#" class="btn btn-primary w-100 mb-2" style="background-color: darkgreen; border: 1px solid black;">Buy now</a>
              <button @click="addToCart(productDetail)" class="btn btn-outline-primary w-100" style="color: darkgreen; border: 1px solid black; background-color: white">Add to Cart</button>
              <div class="d-flex align-items-center my-3">
                <i class="fas fa-user-circle me-2" style="font-size: 40px; color: darkgreen;"></i>
                <div>
                  <h6 class="mb-0">Dewa Gede Mika Waiswana</h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content p-3">
            <div class="modal-body text-center">
              <i class="fas fa-shopping-cart mb-3" style="font-size: 100px; color: darkgreen;"></i>
